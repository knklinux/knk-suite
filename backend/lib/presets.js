...
const PRESETS = {
  ...
  'adobe-intigriti': {
    ...
    scope: [
      ...
      'firefly-3p.ff.adobe.io', 'image-v5.ff.adobe.io', '*.ff.adobe.io',
      'adobe.io', '*.adobe.io',
  ...
  'kiteworks-h1': {
    ...
    userAgent: 'knk-suite-researcher/2.0 bug-bounty-knk_linux',
    opplanBase: {
      nombre: 'Kiteworks H1 — caza sin login',
      objetivo: 'MFT/Airflow open-source: endpoints subida/descarga, NaN en formularios, recon de scopes. Foco unauthenticated→RCE (bonus $25k).',
      reglas: 'H1 > todo. Automatización suave (rate limit explícito en política). Reportar en 24h tras descubrir.',
    },
    notas: [
      'Hosts dataset: ywh-kw-public/kw-bugcrowd-main/kw-bugcrowd-pub/ywh-kw-res-h3 (.bounty.kiteworks.dev).',
      'Alta competencia (158/mes): prioriza vectores frescos, no genéricos.',
    ],
  },
  'epicgames-h1': {
    id: 'epicgames-h1',
    nombre: 'Epic Games — HackerOne (67 activos)',
    programUrl: 'https://hackerone.com/epicgames',
    scope: ['epicgames.com', '*.epicgames.com', 'unrealengine.com', '*.unrealengine.com'],
    outOfScope: [],
    rateLimitMs: 2500,
    userAgent: 'knk-suite-researcher/2.0 bug-bounty-knk_linux',
    opplanBase: {
      nombre: 'Epic H1 — caza sin login',
      objetivo: 'Recon/takeover sobre decenas de subs; CORS en APIs launcher/tienda; SSRF en previsualizadores.',
      reglas: 'H1 > todo. Sin login salvo cuenta propia. Sin DoS.',
    },
    notas: ['Bounty lento (153d). Wildcards amplios: artstation/amplitude-game según dataset.'],
  },
  'marriott-h1': {
    id: 'marriott-h1',
    nombre: 'Marriott — HackerOne (76 activos, UAT/gateways)',
    programUrl: 'https://hackerone.com/marriott',
    scope: ['marriott.com', '*.marriott.com'],
    outOfScope: [],
    rateLimitMs: 2500,
    userAgent: 'knk-suite-researcher/2.0 bug-bounty-knk_linux',
    opplanBase: {
      nombre: 'Marriott H1 — caza sin login',
      objetivo: 'Recon UAT/gateways (*uat, gateway*, dcfgateway*), errores verbosos, NaN en APIs de reservas públicas.',
      reglas: 'H1 > todo. Sin login salvo cuenta propia. Triage exigente en lows: solo impacto real.',
    },
    notas: ['Eficiencia 97%, primera respuesta 1d. Patrones de entorno olvidados = oro.'],
  },
  'rockstargames-h1': {
    id: 'rockstargames-h1',
    nombre: 'Rockstar — HackerOne (bounty 1d, 8 activos)',
    programUrl: 'https://hackerone.com/rockstargames',
    scope: ['rockstargames.com', '*.rockstargames.com', 'socialclub.rockstargames.com'],
    outOfScope: [],
    rateLimitMs: 2500,
    userAgent: 'knk-suite-researcher/2.0 bug-bounty-knk_linux',
    opplanBase: {
      nombre: 'Rockstar H1 — caza sin login',
      objetivo: 'CORS/open-redirect en web; NaN en APIs públicas (juegos/leaderboards); recon wildcard.',
      reglas: 'H1 > todo. Sin login salvo cuenta propia. Sin DoS.',
    },
    notas: ['Bounty más rápido medido (1d tras triage). Scope pequeño: peinar a fondo.'],
  },
  'playstation-h1': {
    id: 'playstation-h1',
    nombre: 'PlayStation — HackerOne (API/store)',
    programUrl: 'https://hackerone.com/playstation',
    scope: ['playstation.com', '*.playstation.com', 'playstation.net', '*.playstation.net'],
    outOfScope: [],
    rateLimitMs: 2500,
    userAgent: 'knk-suite-researcher/2.0 bug-bounty-knk_linux',
    opplanBase: {
      nombre: 'PlayStation H1 — caza sin login',
      objetivo: 'Recon api wildcard; CORS en store API; takeover en playstation.net; endpoints store sin auth.',
      reglas: 'H1 > todo. Equipo maduro: solo vectores no triviales. Sin DoS.',
    },
    notas: ['Pago lento (195-305d). Los fáciles ya están tomados: buscar lógica profunda.'],
  },
  'payoneer-h1': {
    id: 'payoneer-h1',
    nombre: 'Payoneer — HackerOne (fintech)',
    programUrl: 'https://hackerone.com/payoneer',
    scope: ['payoneer.com', '*.payoneer.com'],
    outOfScope: [],
    rateLimitMs: 2500,
    userAgent: 'knk-suite-researcher/2.0 bug-bounty-knk_linux',
    opplanBase: {
      nombre: 'Payoneer H1 — caza sin login',
      objetivo: 'NaN en conversores/cotizadores públicos; CORS en marketing; open-redirect en registro.',
      reglas: 'H1 > todo. Fintech con WAF: ritmo humano, 1 sonda cada 2.5s+. Sin DoS.',
    },
    notas: ['Respuesta 0d. Pagan bien lógica de negocio. Ojo WAF sensible.'],
  },
  'infomaniak-ywh': {
    id: 'infomaniak-ywh',
    nombre: 'Infomaniak — YesWeHack (46 scopes, APARCADO)',
    programUrl: 'https://yeswehack.com/programs',
    scope: ['infomaniak.com', '*.infomaniak.com'],
    outOfScope: [],
    rateLimitMs: 3000,
    userAgent: 'knk-suite-researcher/2.0 bug-bounty-knk_linux',
    opplanBase: {
      nombre: 'Infomaniak YWH — APARCADO (sin PoC no hay crédito)',
      objetivo: 'APARCADO: solo con PoC completo y validado. CORS propio pendiente.',
      reglas: 'YWH > todo. Sin PoC demostrable no se reporta (lección aprendida).',
    },
    notas: ['APARCADO por decisión: YWH no da crédito sin PoC. Solo entrar con hallazgo validado en mano.'],
  },
};
